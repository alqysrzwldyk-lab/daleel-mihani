...
export default function EditJobPage() {
  ...
  if (loading) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-12 flex items-center justify-center gap-3 text-[var(--muted)]">
        ...
        <span className="text-sm font-bold">جاري تحميل الإعلان...</span>
      </div>
    );
  }
  ...
  if (error || !job) {
    return (
      <div className="max-w-3xl mx-auto px-4 py-24 text-center">
        ...
        <h1 className="text-xl font-black text-[var(--foreground)]">{error || "الإعلان غير موجود"}</h1>
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        <h1 className="text-2xl md:text-3xl font-black text-[var(--foreground)]">تعديل الإعلان الوظيفي</h1>
        <p className="text-sm text-[var(--muted)] mt-1.5">عدّل تفاصيل الوظيفة ثم احفظ التغييرات لتحديث الإعلان مباشرة.</p>
      </div>
